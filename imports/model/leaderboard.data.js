const ISODate = (dateString) => dateString;

const LEADERBOARD_JSON = {
  _weekId: 'deJmXfYBh3ZtTJcJ7',
  _players: [
		/* 1 */
		{
			"_id" : "ynufzYT3fSS2KTbnq",
			"createdAt" : ISODate("2023-09-04T10:46:07.659-04:00"),
			"username" : "Nik.Nina.01",
			"emails" : [
				{
					"address" : "nik.nina.01@gmail.com ",
					"verified" : false
				}
			]
		},
		...
		/* 2 */
		{
			"_id" : "vpNDN6pmuYoo4zXpd",
			"createdAt" : ISODate("2023-09-01T10:10:50.785-04:00"),
			"username" : "Rach",
			"emails" : [
				{
					"address" : "purpleskittle_81@hotmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 3 */
		{
			"_id" : "rcnjer9JGYoM7u7P8",
			"createdAt" : ISODate("2023-09-04T10:37:11.639-04:00"),
			"username" : "tulegz",
			"emails" : [
				{
					"address" : "tulegz@gmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 4 */
		{
			"_id" : "gdMch5DSaSnEBhFvj",
			"createdAt" : ISODate("2023-09-04T10:06:38.636-04:00"),
			"username" : "Joemama",
			"emails" : [
				{
					"address" : "liamcatmix@gmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 5 */
		{
			"_id" : "bYwbLMuizsjWfy3pK",
			"createdAt" : ISODate("2023-09-04T10:05:04.446-04:00"),
			"username" : "SaccoMyQB",
			"emails" : [
				{
					"address" : "Sacman_11@hotmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 6 */
		{
			"_id" : "aGdZrDuNw9bm5bNsi",
			"createdAt" : ISODate("2023-08-30T19:17:04.438-04:00"),
			"username" : "Timbro",
			"emails" : [
				{
					"address" : "tjscooper@me.com",
					"verified" : false
				}
			]
		},
		...
		/* 7 */
		{
			"_id" : "XXQWtuAjrCD7xBKax",
			"createdAt" : ISODate("2023-09-04T11:11:03.340-04:00"),
			"username" : "KibblesAndVic",
			"emails" : [
				{
					"address" : "tarafullerton@hotmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 8 */
		{
			"_id" : "PWk34G2Kvm7JTr8N6",
			"createdAt" : ISODate("2023-09-07T09:39:08.181-04:00"),
			"username" : "MoneyKa$h",
			"emails" : [
				{
					"address" : "g.mike.bird@gmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 9 */
		{
			"_id" : "M6kLkeuqDkvatHw4m",
			"createdAt" : ISODate("2023-09-04T10:05:30.734-04:00"),
			"username" : "Stanos",
			"emails" : [
				{
					"address" : "standothemando@gmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 10 */
		{
			"_id" : "HC2uX696gjzuzyknR",
			"createdAt" : ISODate("2023-09-04T15:53:34.409-04:00"),
			"username" : "MMAC",
			"emails" : [
				{
					"address" : "martymacintyre@gmail.com",
					"verified" : false
				}
			]
		},
		...
		/* 11 */
		{
			"_id" : "4qE5m8FnfoKEXaJuC",
			"createdAt" : ISODate("2023-09-04T18:47:21.424-04:00"),
			"username" : "cbw814",
			"emails" : [
				{
					"address" : "cbw814@gmail.com",
					"verified" : false
				}
			]
		}
  ...
  _picks: [
		/* 1 */
		{
			"_id" : "zqJ9bbMTDtSSkxYpy",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547407",
			"teamId" : "9",
			"userId" : "HC2uX696gjzuzyknR",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 2 */
		{
			"_id" : "zoYXbma6PJnoGseAE",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547404",
			"teamId" : "30",
			"userId" : "aGdZrDuNw9bm5bNsi",
			"meta" : {
				"entity" : "PICK"
			},
			"updatedAt" : ISODate("2023-09-04T10:02:32.582-04:00")
		},

		/* 3 */
		{
			"_id" : "zTWa8vxZEPTpWtvD8",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547400",
			"teamId" : "13",
			"userId" : "gdMch5DSaSnEBhFvj",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 4 */
		{
			"_id" : "ytA6iA2EWGZj4mSoQ",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547401",
			"teamId" : "15",
			"userId" : "ynufzYT3fSS2KTbnq",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 5 */
		{
			"_id" : "yBSRrKQcZgs5ZPchn",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547398",
			"teamId" : "16",
			"userId" : "vpNDN6pmuYoo4zXpd",
			"meta" : {
				"entity" : "PICK"
			},
			"updatedAt" : ISODate("2023-09-07T23:23:27.608-04:00")
		},

		/* 6 */
		{
			"_id" : "y5wipbZGdnFT2zc7A",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547398",
			"teamId" : "16",
			"userId" : "aGdZrDuNw9bm5bNsi",
			...
			"updatedAt" : ISODate("2023-09-04T10:02:19.086-04:00")
		},

		/* 7 */
		{
			"_id" : "y2WSWWDuh6sHAfSr5",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547399",
			"teamId" : "10",
			"userId" : "XXQWtuAjrCD7xBKax",
			"meta" : {
				"entity" : "PICK"
			},
			"updatedAt" : ISODate("2023-09-04T20:55:58.848-04:00")
		},

		/* 8 */
		{
			"_id" : "xpNLGSQNChgBekbGo",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547405",
			"teamId" : "23",
			"userId" : "M6kLkeuqDkvatHw4m",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 10 */
		{
			...
			"updatedAt" : ISODate("2023-09-07T23:23:36.961-04:00")
		},

		/* 11 */
		{
			"_id" : "xaFv7wzjb6Wbn4GYg",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547408",
			"teamId" : "14",
			"userId" : "PWk34G2Kvm7JTr8N6",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 13 */
		{
			"_id" : "x6xPtxjFuvLMBHbSX",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547402",
			"teamId" : "21",
			"userId" : "4qE5m8FnfoKEXaJuC",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 17 */
		{
			...
			"updatedAt" : ISODate("2023-09-08T08:36:25.890-04:00")
		},

		/* 18 */
		{
			"_id" : "uzNZ4wkx63LpEu6Nw",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547407",
			"teamId" : "9",
			"userId" : "PWk34G2Kvm7JTr8N6",
		...
		/* 21 */
		{
			...
			"updatedAt" : ISODate("2023-09-04T10:02:40.001-04:00")
		},

		/* 22 */
		{
			"_id" : "twq79Dm9rNPS4FK6s",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547406",
			"teamId" : "22",
			"userId" : "M6kLkeuqDkvatHw4m",
			...
			"updatedAt" : ISODate("2023-09-04T10:07:01.928-04:00")
		},

		/* 23 */
		{
			"_id" : "tTksiDWi2CQ2DZHJj",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547352",
			"teamId" : "2",
			"userId" : "aGdZrDuNw9bm5bNsi",
			...
			"updatedAt" : ISODate("2023-09-04T10:03:02.035-04:00")
		},

		/* 24 */
		{
			"_id" : "tF6kScSuAis8To6aa",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547399",
			"teamId" : "18",
			"userId" : "4qE5m8FnfoKEXaJuC",
		...
		/* 25 */
		{
			"_id" : "r2zZpJJZta9pwvCG6",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547399",
			"teamId" : "18",
			"userId" : "bYwbLMuizsjWfy3pK",
			"meta" : {
				"entity" : "PICK"
			}
		},
		...
		/* 26 */
		{
			...
			"updatedAt" : ISODate("2023-09-04T20:58:10.241-04:00")
		},

		/* 27 */
		{
			"_id" : "pRtaJeYs4n6szmgHw",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547409",
			"teamId" : "19",
			"userId" : "bYwbLMuizsjWfy3pK",
		...
		/* 30 */
		{
			...
			"updatedAt" : ISODate("2023-09-07T23:23:45.550-04:00")
		},

		/* 31 */
		{
			"_id" : "oaXdPc4ag2Quq9CDX",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547408",
			"teamId" : "26",
			"userId" : "HC2uX696gjzuzyknR",
		...
		/* 44 */
		{
			...
			"updatedAt" : ISODate("2023-09-04T10:14:43.749-04:00")
		},

		/* 45 */
		{
			"_id" : "jGffHjwmJnAjuTnnc",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547409",
			"teamId" : "6",
			"userId" : "ynufzYT3fSS2KTbnq",
		...
		/* 46 */
		{
			...
			"updatedAt" : ISODate("2023-09-04T20:57:18.892-04:00")
		},

		/* 47 */
		{
			"_id" : "j2aFvTcqTowAn3vos",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"gameId" : "401547408",
			"teamId" : "26",
			"userId" : "bYwbLMuizsjWfy3pK",
  ...
  _games: [
		/* 1 */
		{
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547352"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:01.111-04:00")
		},
	
		/* 2 */
		{
			"_id" : "wXpseSDp8xqFbdTm8",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547409",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547409"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:01.088-04:00")
		},
	
		/* 3 */
		{
			"_id" : "vCj29BAiWDLkejkJh",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547398",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547398"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.621-04:00")
		},
	
		/* 4 */
		{
			"_id" : "rAJLETnxuBCgDfheT",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547407",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547407"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.739-04:00")
		},
	
		/* 5 */
		{
			"_id" : "qcT92m9enCjgzoSpf",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547408",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547408"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:01.061-04:00")
		},
	
		/* 6 */
		{
			"_id" : "pfk5mNmdvHWWPa2Lk",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547405",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547405"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.725-04:00")
		},
	
		/* 7 */
		{
			"_id" : "i2puvwNoTKXrGnFsn",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547396",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547396"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.736-04:00")
		},
	
		/* 8 */
		{
			"_id" : "hh7Azb8TLdoyLpWTD",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547406",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547406"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.729-04:00")
		},
	
		/* 9 */
		{
			"_id" : "aeGrTHqEnLsYgxDwN",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547401",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547401"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:01.013-04:00")
		},
	
		/* 10 */
		{
			"_id" : "Z9DYRm7LffbupohkK",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547400",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547400"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.873-04:00")
		},
	
		/* 11 */
		{
			"_id" : "YxHShhQyKWm4aDQzi",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547402",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547402"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.958-04:00")
		},
	
		/* 12 */
		{
			"_id" : "Y8M7zFH3ZAMwLgv2J",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547353",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547353"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.449-04:00")
		},
	
		/* 13 */
		{
			"_id" : "MRmzS8EWpG9JwfWip",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547397",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547397"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.539-04:00")
		},
	
		/* 14 */
		{
			"_id" : "FSsSP9WMpsAjZ9ge8",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547404",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547404"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.551-04:00")
		},
	
		/* 15 */
		{
			"_id" : "6oEnNvq3hjaPtyWyi",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547403",
			...
			"meta" : {
				"gameUrl" : "https://www.espn.com/nfl/game/_/gameId/401547403"
			},
			"updatedAt" : ISODate("2023-09-13T00:03:00.522-04:00")
		},
	
		/* 16 */
		{
			"_id" : "3iLM8DnpFBLesJZib",
			"weekId" : "deJmXfYBh3ZtTJcJ7",
			"weekNumber" : 1,
			"gameId" : "401547399",
